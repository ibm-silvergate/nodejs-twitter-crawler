 ...
 */
var MAX_COUNT, Promise, TwitterClient, TwitterCrawler, _extend, extend,
  slice = [].slice;
    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        crawler = function(incomingTweets) {
          ...
          _this.logger('Obtained', incomingTweets.length, 'for userId', params.user_id + '.', 'Total tweets for user:', incomingTweets.length + accumulatedTweets.length);
